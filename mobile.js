if (window.innerWidth < 1400) {
    ...
    function checkPosition(item) {
        ...
        if ((Math.abs(item.getBoundingClientRect().left - wrapperX - (wrapper.offsetWidth * imagesPosition[index].left / 100)) < 2) &&
            (Math.abs(item.getBoundingClientRect().top - wrapperY - (wrapper.offsetHeight * imagesPosition[index].top / 100)) < 2)) {
